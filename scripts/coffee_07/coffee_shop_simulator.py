...
class CoffeeShopSimulator:
    ...
    def run(self):
        ...
        def simulate(self, temperature, advertising, cup_price):
            ...
            self.sales.append({
                "day": self.day,
                "coffee_inv": self.coffee_innventory,
            ...
            # read from the sales list when have the data right here
            return cups_sold
        def make_temp_distribution(self):
            # This is not a good bell curve, but it will do for now
            # until we get more advanced mathematics
            temps = []

            # First, find the average between the TEMP_MIN and TEMP_MAX
