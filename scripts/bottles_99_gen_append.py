...
# this_verse is initialized as an empty array, and each loop creates a string which is appended to the array. Finally, it is printed. More # # efficient in use of system resources than other versions.   